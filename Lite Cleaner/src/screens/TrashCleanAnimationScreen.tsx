...
interface TrashCleanAnimationScreenProps {
  navigation?: any;
}

export const TrashCleanAnimationScreen: React.FC<TrashCleanAnimationScreenProps> = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const cleanupTimer = setTimeout(() => {
      const startAnimations = () => {
        // Çöp kutusu animasyonu - pulse efekti
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.headerTitle}>Çöp Kutusu Temizliği</Text>
        ...
        <View style={styles.content}>
          ...
          >
            ...
            {/* Ana ikon container */}
            <Animated.View style={[styles.mainIconContainer, trashAnimatedStyle]}>
              <LinearGradient
              ...
              >
                <Ionicons name="trash-bin" size={60} color="white" />
              </LinearGradient>
            </Animated.View>
                ...
                {isComplete ? (
                  <Animated.View style={checkmarkAnimatedStyle}>
                    <View style={styles.checkmarkContainer}>
                      <Ionicons name="checkmark-circle" size={50} color="#f59e0b" />
                    </View>
                  </Animated.View>
                ) : (
            ...
            >
              <View style={styles.statusHeader}>
                ...
                <Text style={styles.statusTitle}>
                  {isComplete ? 'Temizlik Tamamlandı!' : 'Çöp kutusu temizleniyor...'}
                </Text>
              </View>
              ...
              {!isComplete && (
                <View style={styles.modernDetailsGrid}>
                  <View style={styles.modernDetailItem}>
                    ...
                    <Text style={styles.modernDetailText}>Geçici dosyalar</Text>
                  </View>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="folder-outline" size={18} color="#f59e0b" />
                    </View>
                    <Text style={styles.modernDetailText}>Boş klasörler</Text>
                  </View>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="trash-outline" size={18} color="#f59e0b" />
                    </View>
                    <Text style={styles.modernDetailText}>Silinmiş öğeler</Text>
                  </View>
                </View>
              )}
            </LinearGradient>
          ...
          {isComplete && (
            ...
            >
              ...
              >
                ...
                <Text style={styles.resultText}>89 MB alan kazanıldı</Text>
