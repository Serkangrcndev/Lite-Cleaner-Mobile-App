...
interface DownloadsCleanAnimationScreenProps {
  navigation?: any;
}

export const DownloadsCleanAnimationScreen: React.FC<DownloadsCleanAnimationScreenProps> = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const cleanupTimer = setTimeout(() => {
      const startAnimations = () => {
        // İndirme ikonu animasyonu - pulse efekti
        downloadScale.value = withRepeat(
          withSequence(
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.headerTitle}>İndirilenler Temizliği</Text>
        ...
        <View style={styles.content}>
          ...
          >
            ...
            {/* Ana ikon container */}
            <Animated.View style={[styles.mainIconContainer, downloadAnimatedStyle]}>
              <LinearGradient
              ...
              >
                <Ionicons name="download" size={60} color="white" />
              </LinearGradient>
            </Animated.View>
            ...
            >
              <Ionicons name="sparkles" size={12} color="#ef4444" />
            </Animated.View>
          </Animated.View>
                ...
                {isComplete ? (
                  <Animated.View style={checkmarkAnimatedStyle}>
                    <View style={styles.checkmarkContainer}>
                      <Ionicons name="checkmark-circle" size={50} color="#ef4444" />
                    </View>
                  </Animated.View>
                ) : (
            ...
            >
              <View style={styles.statusHeader}>
                ...
                <Text style={styles.statusTitle}>
                  {isComplete ? 'Temizlik Tamamlandı!' : 'İndirilenler temizleniyor...'}
                </Text>
              </View>
              
              <Text style={styles.statusSubtitle}>
                {isComplete ? `${cleanedSize} alan temizlendi` : 'Gereksiz dosyalar siliniyor'}
              </Text>
              ...
              {!isComplete && (
                <View style={styles.modernDetailsGrid}>
                  <View style={styles.modernDetailItem}>
                    ...
                    <Text style={styles.modernDetailText}>İndirilen dosyalar</Text>
                  </View>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="archive-outline" size={18} color="#ef4444" />
                    </View>
                    <Text style={styles.modernDetailText}>Arşiv dosyaları</Text>
                  </View>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="image-outline" size={18} color="#ef4444" />
                    </View>
                    <Text style={styles.modernDetailText}>Görsel dosyalar</Text>
                  </View>
                </View>
              )}
            </LinearGradient>
          ...
          {isComplete && (
            ...
            >
              ...
              >
                ...
                <Text style={styles.resultText}>128 MB alan kazanıldı</Text>
                <View style={styles.resultStats}>
                  <View style={styles.statItem}>
                    <Text style={styles.statNumber}>89</Text>
                    <Text style={styles.statLabel}>Dosya Silindi</Text>
                  </View>
                  <View style={styles.statItem}>
                    <Text style={styles.statNumber}>12</Text>
                    <Text style={styles.statLabel}>Klasör Temizlendi</Text>
                  </View>
                </View>
              </LinearGradient>
            </Animated.View>
