...
interface TempFilesCleanAnimationScreenProps {
  navigation?: any;
}

export const TempFilesCleanAnimationScreen: React.FC<TempFilesCleanAnimationScreenProps> = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const cleanupTimer = setTimeout(() => {
      const startAnimations = () => {
        // Temp dosya ikonu animasyonu - pulse efekti
        tempScale.value = withRepeat(
          withSequence(
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.headerTitle}>Geçici Dosyalar Temizliği</Text>
        ...
        <View style={styles.content}>
          ...
          >
            ...
            >
              <LinearGradient
                colors={['rgba(6, 182, 212, 0.1)', 'rgba(8, 145, 178, 0.05)']}
                style={styles.backgroundGradient}
              />
            </Animated.View>
            
            {/* Ana ikon container */}
            <Animated.View style={[styles.mainIconContainer, tempAnimatedStyle]}>
              <LinearGradient
              ...
              >
                <Ionicons name="document" size={60} color="white" />
              </LinearGradient>
            </Animated.View>
                ...
                {isComplete ? (
                  <Animated.View style={checkmarkAnimatedStyle}>
                    <View style={styles.checkmarkContainer}>
                      <Ionicons name="checkmark-circle" size={50} color="#06b6d4" />
                    </View>
                  </Animated.View>
                ) : (
            ...
            >
              <View style={styles.statusHeader}>
                ...
                <Text style={styles.statusTitle}>
                  {isComplete ? 'Temizlik Tamamlandı!' : 'Geçici dosyalar temizleniyor...'}
                </Text>
              </View>
              
              <Text style={styles.statusSubtitle}>
                {isComplete ? `${cleanedSize} alan temizlendi` : 'Sistem geçici dosyaları siliniyor'}
              </Text>
                ...
                <View style={styles.modernDetailsGrid}>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="folder-outline" size={18} color="#06b6d4" />
                    </View>
                    <Text style={styles.modernDetailText}>Sistem Temp</Text>
                  </View>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="time-outline" size={18} color="#06b6d4" />
                    </View>
                    <Text style={styles.modernDetailText}>Geçici Loglar</Text>
                  </View>
                  <View style={styles.modernDetailItem}>
                    <View style={styles.detailIconContainer}>
                      <Ionicons name="settings-outline" size={18} color="#06b6d4" />
                    </View>
                    <Text style={styles.modernDetailText}>Sistem Cache</Text>
                  </View>
                </View>
              )}
            </LinearGradient>
              ...
              >
                ...
                <View style={styles.resultStats}>
                  <View style={styles.statItem}>
                    ...
                    <Text style={styles.statLabel}>Temp Dosya</Text>
                  </View>
                  <View style={styles.statItem}>
                    <Text style={styles.statNumber}>23</Text>
                    <Text style={styles.statLabel}>Log Dosyası</Text>
                  </View>
                </View>
              </LinearGradient>
            </Animated.View>
